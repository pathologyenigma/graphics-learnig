use ray_tracing_the_next_week::{Camera, Color, Point3, Vec3, random_float};

mod random_scene {
    use std::{cell::RefCell, rc::Rc};

    use ray_tracing_the_next_week::{Color, Dielectric, HittableList, Lambertian, Material, Metal, MovingSphere, Point3, Sphere, Vec3, random_float, random_float_with_range};
            ...
            for b in -11..11 {
                ...
                if (center - Point3::new((4., 0.2, 0.))).len() > 0.9 {
                    ...
                    if choose_mat < 0.8 {
                        ...
                        let center2 = center + Vec3::new((0., random_float_with_range(0., 0.5), 0.));
                        world.add(Rc::new(RefCell::new(MovingSphere::new((center,center2), (0., 1.), 0.2, sphere_mat))));
...
fn main() {
    ...
    let cam = Camera::new(lookfrom, lookat, vup, 20., ASPECT_RATIO, 0.1, dist_to_focus, 0., 1.);
